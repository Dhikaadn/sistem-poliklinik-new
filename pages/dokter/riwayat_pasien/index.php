...
?>
<?php
$title = 'Poliklinik | Histori Pasien';
// Breadcrumb section
ob_start(); ?>
<ol class="breadcrumb float-sm-right">
  <li class="breadcrumb-item"><a href="<?= $base_dokter; ?>">Home</a></li>
  <li class="breadcrumb-item active">Histori Pasien</li>
</ol>
<?php
      ...
      <tbody>
        ...
        ?>
            <tr>
              ...
              <td><?= $d['no_rm']; ?></td>
              <td>
                <button data-toggle="modal" data-target="#detailModal<?= $d['id'] ?>" class="btn btn-success btn-sm"><i class="fa fa-eye"></i> Detail Riwayat Periksa
                </button>
              </td>
            </tr>
