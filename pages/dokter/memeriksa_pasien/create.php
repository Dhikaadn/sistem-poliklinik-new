    ...
    <div class="card-body">
        <form action="" method="POST">
            ...
            <div class="form-group">
                ...
                <select multiple="" class="form-control" name="obat[]" multiple>
                    <?php foreach ($obat as $obats) : ?>
                        <?php if ($obats['status'] == 'Y') : ?>
                        <option value="<?= $obats['id']; ?>|<?= $obats['harga'] ?>"><?= $obats['nama_obat']; ?> - <?= $obats['kemasan']; ?> - Rp.<?= $obats['harga']; ?> - <?= $obats['status']; ?></option>
                        <?php endif; ?>
                    <?php endforeach; ?>
                </select>
            </div>
            ...
            <div class="d-flex justify-content-end">
                <button type="submit" class="btn btn-success" id="simpan_periksa" name="simpan_periksa">
                Save</button>
            </div>
        </form>
        <?php
