        ...
        <div class="col mb-2">
          ...
          <div class="kotak-luar mt-3">
            <a href="<?= $base_pasien ?>">
              ...
              <div class="card-header"><strong>Menu Dashboard</strong></div>
                <div class="card-body">
                  <p class="card-text">Tampilan dashboard atau menu utama dari halaman pasien</p>
                </div>
              </div>
            </a>
            <a href="<?= $base_pasien.'/poli'?>">
